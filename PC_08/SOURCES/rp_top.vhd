...
----------------------------------------------------------------------------------
    ...
    PORT (
      clk        : IN STD_LOGIC;
      probe_out0 : OUT STD_LOGIC_VECTOR(3 DOWNTO 0); -- DIG1
      probe_out1 : OUT STD_LOGIC_VECTOR(3 DOWNTO 0); -- DIG2
      probe_out2 : OUT STD_LOGIC_VECTOR(3 DOWNTO 0); -- DIG3
      probe_out3 : OUT STD_LOGIC_VECTOR(3 DOWNTO 0); -- DIG4
      probe_out4 : OUT STD_LOGIC_VECTOR(3 DOWNTO 0); -- DP (tečky)
      probe_out5 : OUT STD_LOGIC_VECTOR(2 DOWNTO 0)  -- DOTS (dvojtečky)
    );
  END COMPONENT;
    ...
    -- (Předpoklad: v IP Catalogu jsi vytvořil vio_btn se šířkou probe_in 4 bity)
    COMPONENT vio_btn
    PORT (
        clk       : IN STD_LOGIC;
  ...
  signal probe_out  : std_logic_vector(63 downto 0); -- To hold all 8 probe_outs
  
  type t_pwm_array is array (0 to 7) of std_logic_vector(7 downto 0);
  signal vio_pwm_refs : t_pwm_array;



  signal vio_dig1, vio_dig2 : std_logic_vector(3 downto 0);
  signal vio_dig3, vio_dig4 : std_logic_vector(3 downto 0);
  signal vio_dp             : std_logic_vector(3 downto 0);
  signal vio_dots           : std_logic_vector(2 downto 0);
----------------------------------------------------------------------------------
BEGIN
----------------------------------------------------------------------------------
...
seg_disp_driver_i : seg_disp_driver
  ...
  PORT MAP(
  CLK        => CLK,
    PWM_REF_0  => vio_pwm_refs(0),
    PWM_REF_1  => vio_pwm_refs(1),
    PWM_REF_2  => vio_pwm_refs(2),
    PWM_REF_3  => vio_pwm_refs(3),
    PWM_REF_4  => vio_pwm_refs(4),
    PWM_REF_5  => vio_pwm_refs(5),
    PWM_REF_6  => vio_pwm_refs(6),
    PWM_REF_7  => vio_pwm_refs(7),
    PWM_OUT    => pwm_out,
    CNT_OUT    => cnt_out
  );
    ...
    clk        => CLK,
      probe_in0 => cnt_out,
      probe_in1  => pwm_out,                   -- Monitor the PWM counter
      probe_out0 => vio_pwm_refs(0),           -- Drive PWM 0 brightness
      probe_out1 => vio_pwm_refs(1),
      probe_out2 => vio_pwm_refs(2),
      probe_out3 => vio_pwm_refs(3),
      probe_out4 => vio_pwm_refs(4),
      probe_out5 => vio_pwm_refs(5),
      probe_out6 => vio_pwm_refs(6),
      probe_out7 => vio_pwm_refs(7)
      );
